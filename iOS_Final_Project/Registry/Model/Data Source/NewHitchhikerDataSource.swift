                ...
                if let error = error {
                    ...
                    if let data = data {
                        ...
                        if (response.success){
                            ...
                            self.user = User(profileImage: profileImage, isDriver: false, username: username, password: password, name: name, surname: surname, email: email, phonenumber: phonenumber, age: age, sex: gender)
                            DispatchQueue.main.async {
